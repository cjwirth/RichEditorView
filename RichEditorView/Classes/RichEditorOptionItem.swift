...
public enum RichEditorOptions: RichEditorOption {
    ...
    public static func all() -> [RichEditorOption] {
        return [
            ...
            alignLeft, alignCenter, alignRight, picture, link
        ]
    }
    ...
    public func image() -> UIImage? {
        ...
        case .picture: name = "insert_image"
    ...
    public func title() -> String {
        ...
        case .picture: return NSLocalizedString("Image", comment: "")
    ...
    public func action(_ toolbar: RichEditorToolbar?) {
        if let toolbar = toolbar {
            ...
            case .picture: toolbar.delegate?.richEditorToolbarInsertImage?(toolbar)
